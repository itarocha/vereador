function confirmdelEmpresa(id) {
    jQuery.fancybox({
        ...
        content: '<div class="w-100 bg-amarelo fancy-header">'
                ...
                + '<span class="f-left b-submit-maior c-branco bg-verde margin-auto b-ic-adicionar" onclick="deletaEmpresa(\'' + id + '\');">OK</span>'
...
function deletaEmpresa(id) {
    $.post(LINK_MODULE + "gerenciamentoempresas/ajaxdelempresa", {
        "id": id
    }, function(data) {
        if (data.msg == 'ok') {
