...
function fecharProcesso(id) {
    $.post(LINK_MODULE + "processoseletivo/ajaxfecharprocesso", {
        ...
        if (data.msg == 'ok') {
            closeFancyboxAndRedirectToUrl(LINK_MODULE + '/processoseletivo');
        } else {
            fancyAlert('Erro ao fechar Processo Seletivo. <br/>Entre em contato com o suporte técnico', 'err', LINK_MODULE + '/index');
        }
